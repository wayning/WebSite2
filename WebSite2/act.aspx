<%@ Page Language="C#" AutoEventWireup="true" CodeFile="act.aspx.cs" Inherits="_Default" %>
...
<body background="./images/7.jpg" style="background-size:cover;">
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="act_id" DataSourceID="SqlDataSource1" OnRowCommand="GridView1_RowCommand1">
            <Columns>
                <asp:TemplateField HeaderText="act_id" SortExpression="act_id">
                    ...
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="viewadd" CommandArgument='<%# Bind("act_id") %>'>進入留言板</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
